...
// import 'package:not_a_note/component/language/c_language.dart';
...
//   String eTimeout = kLanguage.connectionTimedOut;
...
//     if (!headers.containsKey('X-TenantID') && Constant.userInfo != null) {
//       headers.addAll({"X-TenantID": Constant.userInfo!.tenantId.toString()});
//     }
//     if (!headers.containsKey('Authorization') && Constant.session?.accessToken != null && hasToken) {
//       headers.addAll({"Authorization": "Bearer ${Constant.session?.accessToken}"});
//     }
//     if (!headers.containsKey('Accept-Language') && Constant.userInfo != null) {
//       headers.addAll({'Accept-Language': CLanguage.locale.toString().contains("vi") ? 'vi-VN' : 'en-EN'});
//     }
...
//             if (showError) CDialog().alert(title: kLanguage.alert, content: "${res.data}");
//           } else {
...
//           if (showError) CDialog().alert(title: kLanguage.error, content: kLanguage.errGettingData);
//           return;
//         }
//       } else {
...
//             break;
//           case 409:
//             if (showError) CDialog().alert(title: kLanguage.error, content: "${res.data["message"] ?? kLanguage.noDataReturned}");
//             break;
//           default:
//             if (showError) CDialog().alert(title: kLanguage.error, content: "${res.data["error"] ?? kLanguage.noDataReturned}");
//             break;
//         }
//       }
//     } catch (e, s) {
...
//       if (showError) CDialog().alert(title: kLanguage.error, content: kLanguage.networkError);
...
//       return;
//     }
//     if (showError) CDialog().alert(title: kLanguage.error, content: kLanguage.errorOccurred);
...
//     Function(String onError) onError,
//   ) {
//     if (showError) CDialog().alert(title: kLanguage.error, content: eTimeout);
...
//     }
//     if (showError) {
//       CDialog().alert(title: kLanguage.alert, content: kLanguage.loginExpired);
//     } else {
