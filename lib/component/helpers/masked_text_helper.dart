...
class MoneyMaskedTextController extends TextEditingController {
  MoneyMaskedTextController({num initialValue = 0, this.decimalSeparator = '', this.thousandSeparator = '.', this.rightSymbol = '', this.leftSymbol = '', this.precision = 0}) {
    _validateConfig();
  ...
  Function afterChange = (String maskedValue, num rawValue) {};

  num _lastValue = 0;

  void updateValue(num value) {
    num valueToUse = value;
